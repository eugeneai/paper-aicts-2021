...
\emph{Citing:} Evgeny A. Cherkashin. Technologies of Semantic WEB as an environment of application development and integration. Вычислительные технологии. \jctyear; \jctvolume(\jctnumber):\pageref*{pagebegin}--\pageref*{pageend}.\linebreak \jctdoi.
\end{abstract}
