...
\begin{frame}
  \frametitle{Information infrastructure for supporting Baikal microbiome research}
  \centering
...
\begin{frame}[fragile]\frametitle{Architecture of services}
  \begin{columns}
    \begin{column}{0.7\linewidth}
      \includegraphics[width=1\linewidth]{architecture-mda-lod-ext-galaxy.pdf}
    \end{column}
...
\begin{frame}
\frametitle{Cartographical WEB-service with knowledge graph of South-Siberian faults}
